<center><h1><b>꧁SL EHI BOT VPS SCRIPT ꧂<b></h1></center>

### ✅ UPDATES & NEW FEATURES
<a href="https://github.com/Slehibot/slehibot-vps-auto-script"><img src="https://i.ibb.co/XSHtYQm/Screenshot-2.png" alt="Screenshot-2" border="0"></a> 
...
### ★ About Script   
Using Slehibot SSH-Script you can easily setup your server with ssh & This will make it easier for you as all the ports will be Auto Open ..
...
``` 
 apt-get update -y; apt-get upgrade -y; apt install vnstat -y; sudo wget https://raw.githubusercontent.com/Slehibot/slehibot-vps-auto-script/main/ssh.sh && sudo chmod +x ssh.sh  && sudo ./ssh.sh 
 ```
...
<a href="https://github.com/Slehibot/slehibot-vps-auto-script"><img src="https://i.ibb.co/qpvCqQR/Screenshot-4.png" alt="Screenshot-1" border="0"></a>
# Hosting 🖥
...
## Code Editor 📦
* [Lakmal Sandaru](https://github.com/Slehibot/)
* [SLEHIBOT](https://www.slehibot.xyz/)
