...
fail_db
echo -e "\nPress Enter to return back" ;read && /etc/slehibot-vps-auto-script/ChangePorts.sh
}
...
case $n in
  ...
  [5] change_udpgw;;
  [6] menu;;
  *) echo -e "${RED}\nInvalid Option. Press Enter to return back to the menu${ENDCOLOR}";read && /etc/slehibot-vps-auto-script/ChangePorts.sh;;
esac
